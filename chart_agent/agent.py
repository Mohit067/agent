...
from .tools.chart import generate_sales_chart
...
root_agent = Agent(
    name="Root_Agent",
    description="Root agent to orchestrate Database Agent and Sales Chart Agent.",
    instruction="You are the Root Agent. Route tasks to Database Agent or Sales Chart Agent based on the user's query.",
    sub_agents=[database_agent, sales_chart_agent],
)
